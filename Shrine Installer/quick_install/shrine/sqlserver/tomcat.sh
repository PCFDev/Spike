...
require "${SHRINE_DB_USER}" "SHRINE_MYSQL_USER must be set"
require "${SHRINE_DB_PASSWORD}" "SHRINE_MYSQL_PASSWORD must be set"
require "${SHRINE_DB_HOST}" "SHRINE_MYSQL_HOST must be set"
...
interpolate_file ../skel/shrine.xml "SHRINE_DB_USER" "$SHRINE_DB_USER" | \
interpolate "SHRINE_DB_PASSWORD" "$SHRINE_DB_PASSWORD" | \
interpolate "SHRINE_DB_NAME" "$SHRINE_DB_NAME" | \
interpolate "SHRINE_DB_HOST" "$SHRINE_DB_HOST" > $SHRINE_TOMCAT_APP_CONF
